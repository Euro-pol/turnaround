...
(function ()
{
    ...
    function Be(e)
    {
        for (var a = 1; a < arguments.length; a++)
        {
            var r = arguments[a] != null ? arguments[a] :
                {}
                , o = Object.keys(r);
            typeof Object.getOwnPropertySymbols == "function" && (o = o.concat(Object.getOwnPropertySymbols(r)
                .filter(function (c)
                {
                    return Object.getOwnPropertyDescriptor(r, c)
                        .enumerable
    ...
    {
        return a = a != null ? a :
            {}, Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(a)) : dr(Object(a))
            .forEach(function (r)
            {
    ...
    function It(e, a)
    {
        ...
        if (r != null)
        {
            ...
            try
            {
                for (r = r.call(e); !(c = (g = r.next())
                        .done) && (o.push(g.value), !(a && o.length === a)); c = !0);
            }
            catch (_)
            {
                u = !0, b = _
    ...
    function Ce(e, a)
    {
        ...
        function _(l)
        {
            ...
            {
                if (o = 1, c && (u = l[0] & 2 ? c.return : l[0] ? c.throw || ((u = c.return) && u.call(c), 0) : c.next) && !(u = u.call(c, l[1]))
                    .done) return u;
    ...
    function lt(e, a, r, o, c, u, g)
    {
        var b = ut(r, c)
            , _ = u ? "h/".concat(u, "/") : ""
            , l = g ? "?".concat(g) : "";
        return "".concat(b, "/cdn-cgi/challenge-platform/")
            .concat(_, "turnstile/if/ov2/av0/rcv")
            .concat(o, "/")
            .concat(e, "/")
            .concat(a, "/")
            .concat(r.theme, "/")
    ...
    function $t(e, a)
    {
        var r, o, c, u = ut(a.params, K)
            , g = "h/".concat("g", "/")
            , b = "".concat(u, "/cdn-cgi/challenge-platform/")
            .concat(g, "feedback-reports/")
            .concat(Ee(e), "/")
            .concat(a.displayLanguage, "/")
    ...
    function Zt(e)
    {
        var a = function (r, o)
        {
            ...
            var g = ft(r.tagName.toLowerCase())
                , b = "".concat(g, "[")
                .concat(c, "]");
            return a(r.parentNode, "/".concat(b)
                .concat(o))
        };
        return a(e, "")
    }
    ...
    function _r(e, a)
    {
        ...
        try
        {
            for (var u = e.widgetMap[Symbol.iterator](), g; !(r = (g = u.next())
                    .done); r = !0)
            {
                var b = Oe(g.value, 2)
                    , _ = b[0]
    ...
    {
        var e = [Mt, Pt];
        y.isRecaptchaCompatibilityMode && e.push(Dt), document.querySelectorAll(e.join(", "))
            .forEach(function (a)
            {
                return ht.render(a)
            })
    ...
    function ar()
    {
        ...
        try
        {
            for (var o = _t[Symbol.iterator](), c; !(e = (c = o.next())
                    .done); e = !0)
            {
                var u = c.value;
                u()
    ...
    function mt(e, a)
    {
        ...
        case U.MANAGED:
            ...
            case V.COMPACT:
                ...
                break;
            case V.INVISIBLE:
                p('Invalid value for parameter "size", expected "'.concat(V.COMPACT, '" or "')
                    .concat(V.NORMAL, '", got "')
                    .concat(c, '"'), 2817);
            case V.NORMAL:
        ...
        case U.INVISIBLE:
            ...
            break;
        default:
            p('Invalid value for parameter "mode", expected "'.concat(U.NON_INTERACTIVE, '", "')
                .concat(U.MANAGED, '" or "')
                .concat(U.INVISIBLE, '", got "')
                .concat(u, '"'), 2818)
        }
    }
    ...
    var ht = function ()
    {
        var e = function (n, i, t, f)
            ...
            , b = function (n, i)
            {
                if (i)
                {
                    ...
                    try
                    {
                        for (var T = t[Symbol.iterator](), s; !(d = (s = T.next())
                                .done); d = !0)
                        {
                            var w = s.value;
            ...
            , l = function (n)
            {
                ...
                document.querySelectorAll(d.join(", "))
                    .forEach(function (E)
                    {
                        return E.remove()
                    });
            ...
            , h = function (n, i)
            {
                ...
                if (T)
                {
                    ...
                    typeof L != "string" && p('Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(typeof L == "undefined" ? "undefined" : C(L), '"'), 3588), Nt(L) || p('Invalid input for parameter "sitekey", got "'.concat(L, '"'), 3589), et(s.size) || p('Invalid type for parameter "size", expected normal|compact, got "'.concat(s.size, '" ')
                        .concat(C(s.size)), 3590), Ye(s.theme) || p('Invalid type for parameter "theme", expected dark|light|auto, got "'.concat(s.theme, '" ')
                        .concat(C(s.theme)), 3591), Qe(s.retry) || p('Invalid type for parameter "retry", expected never|auto, got "'.concat(s.retry, '" ')
                        .concat(C(s.retry)), 3592), s.language || (s.language = "auto"), nt(s.language) || (x('Invalid language value: "'.concat(s.language, ", expected either: auto, or an ISO 639-1 two-letter language code (e.g. en) or language and country code (e.g. en-US)")), s.language = "auto"), at(s.appearance) || p('Unknown appearance value: "'.concat(s.appearance, ", expected either: 'always', 'execute', or 'interaction-only'."), 3600), it(s.execution) || p('Unknown execution value: "'.concat(s.execution, ", expected either: 'render' or 'execute'."), 3601), Ke(s["retry-interval"]) || p('Invalid retry-interval value: "'.concat(s["retry-interval"], ', expected an integer value > 0 and < 900000"'), 3602), $e(s["expiry-interval"]) || p('Invalid expiry-interval value: "'.concat(s["expiry-interval"], ', expected an integer value > 0 and < 360000"'), 3602);
                    var ye, G = (ye = s["refresh-expired"]) !== null && ye !== void 0 ? ye : X.AUTO;
                    tt(G) ? s["refresh-expired"] = G : p('Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'.concat(G, '" ')
                        .concat(typeof G == "undefined" ? "undefined" : C(G)), 3603);
                    var he, ie = (he = s["refresh-timeout"]) !== null && he !== void 0 ? he : Z.AUTO;
                    rt(G) ? s["refresh-timeout"] = ie : p('Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'.concat(ie, '" ')
                        .concat(typeof ie == "undefined" ? "undefined" : C(ie)), 3603);
            ...
            , k = function ()
            {
                ...
                try
                {
                    for (var m = y.widgetMap[Symbol.iterator](), E; !(t = (E = m.next())
                            .done); t = !0)
                    {
                        var T = Oe(E.value, 2)
                            , s = T[0]
            ...
            return F = wt(function (v, n, i, t)
            {
                ...
                return Ce(this, function (A)
                {
                    ...
                    case 0:
                        ...
                        m = "h/".concat("g", "/"), E = new URL(d), T = "https", s = "", w = "".concat(T, "://")
            ...
            if (n.source === P)
            {
                ...
                if (!(!n.widgetId || !y.widgetMap.has(n.widgetId)))
                {
                    ...
                    case "init":
                    {
                        ...
                        d || p("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074), t.mode = n.mode, t.mode === U.INVISIBLE && t.params["refresh-expired"] === X.MANUAL && x("refresh-expired=manual is impossible in invisible mode, consider using '".concat(X.AUTO, "' or '")
                            .concat(X.NEVER, "'")), t.mode !== U.MANAGED && t.params["refresh-timeout"] !== Z.AUTO && x("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."), t.params.appearance === q.ALWAYS || t.isExecuting && t.params.appearance === q.EXECUTE ? mt(d, t) : ir(d), d.style.display = "";
                    ...
                    case "translationInit":
                    {
                        ...
                        var T = new Map;
                        t.displayLanguage = n.displayLanguage, Object.keys(n.translationData)
                            .forEach(function (oe)
                            {
                    ...
                    {
                        x("Language ".concat(t.params.language, " is not supported, falling back to: ")
                            .concat(n.fallback)), t.displayLanguage = n.fallback;
                        break
                    }
                    case "reject":
                    {
                        ...
                        var ye = {}
                            ...
                            , he = {
                                ...
                                , pi:
                                {
                                    ...
                                    , mL: document.getElementsByTagName("meta")
                                        .length
                                    , t: tr(document.title)
                                    , tL: document.getElementsByTagName("*")
                                        .length
        ...
        function S(v)
        {
            ...
            return v || y.widgetMap.size === 0 ? null : y.widgetMap.keys()
                .next()
                .value
        }
        return {
    ...
    {
        typeof window[z] == "function" ? window[z]() : (x("Unable to find onload callback '".concat(z, "' immediately after loading, expected 'function', got '")
            .concat(C(window[z]), "'")), setTimeout(function ()
        {
            typeof window[z] == "function" ? window[z]() : x("Unable to find onload callback '".concat(z, "' after 1 second, expected 'function', got '")
                .concat(C(window[z]), "'"))
        }, 1e3))
